#COSC 112 Group 11 Final Project

#The problem that we are trying to solve is how can a person figure out which groceries they need to buy based on what food they currently have, what is their diet, and the recipes they want to make? Currently, our society has issues with wasting food and obesity. Our project will help prevent food waste, obesity, confusion when visiting the grocery store, and increase time management.

#Our Algorithm
#Create text files for current ingredients, recipes names, and ingredients- Mariah Walker
#Write code to open text files and read data- Mariah Walker
#Create recipe object instances- Mariah Walker
#Create a recipe base class- Marcus Cusaac
#Create derived classes for each diet type using inheritance, and polymorphism- Marcus Cusaac and Theodore Wimberly
#Write code to prompt the user to input what food they currently have, what is their diet, and what recipes do they want to make? - Theodore Wimberly
#Create a print statement to show the data in the ingredients text file- Theodore Wimberly
...
def main():
  ...
  # Close input files-Mariah Walker
